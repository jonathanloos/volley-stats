...
class Events::DestroyService < ApplicationService
  ...
  def call
    Event.transaction do
      ...
      # undo substitution
      Players::SubstitutionService.call(incoming_player: @event.player, player: @event.incoming_player, undo_action: true) if @event.substitution? || @event.libero_substitution?
